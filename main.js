...
//* state.flags - буфер для хранения уже сгенерированных флагов
        ...
        function markerMouseoverHandler(event) {
            ...
            window.addEventListener('scroll', flagRemoverScrollHandler, {once: true})
        }
        ...
        function flagRemoverScrollHandler() {
            document.querySelector('.flag')?.remove();
            countriesBordersArr.forEach(country => country.classList.remove('highlighted'));
        }
